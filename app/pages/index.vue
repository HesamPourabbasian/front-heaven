...
<template>
  <div class="overflow-clip">
    <!-- Hero -->
    <section class="relative overflow-hidden pt-16 pb-16 sm:pt-24 sm:pb-24" aria-labelledby="hero-heading">
      ...
      <div class="absolute inset-0 -z-10 overflow-hidden pointer-events-none select-none">
        <img
          ...
          class="h-full w-full object-cover object-center opacity-20 dark:opacity-30 filter blur-xs"
        />
      ...
      <div class="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div class="mx-auto max-w-3xl text-center">
          ...
          <h1 id="hero-heading" class="animate-fade-up mt-7 font-display text-4xl leading-[1.08] font-bold tracking-tight text-ink sm:text-6xl" style="animation-delay: 60ms">
            Learn Front-End Development.
            <span class="gradient-text block mt-1">The Right Way.</span>
          </h1>

          <p class="animate-fade-up mx-auto mt-6 max-w-2xl text-base leading-relaxed text-muted sm:text-lg" style="animation-delay: 120ms">
          ...
          <dl class="animate-fade-up mx-auto mt-14 grid max-w-2xl grid-cols-2 gap-3 sm:grid-cols-4 sm:gap-4" style="animation-delay: 240ms">
            <div v-for="stat in stats" :key="stat.label" class="group flex min-h-[5.5rem] flex-col justify-between rounded-2xl border border-border/80 bg-surface/80 backdrop-blur-md px-4 py-5 text-center transition-all duration-200 hover:border-primary/40 hover:shadow-lg sm:min-h-28">
